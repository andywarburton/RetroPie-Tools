#==============================================================================#
# This program is intended to remove any roms from RetroPie that are
...
incomplete_types = rpitools.incom_types
        ...
        with open(list_file_path, 'wb') as list_file:
            ...
            for filename in files:
                ...
                if system_name in allowed_systems:
                    ...
                    if any(p in rom_name for p in incomplete_types):
